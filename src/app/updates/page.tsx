...
export default function page() {
  ...
  return (
    <div className='overflow-x-hidden   mt-20 mb-56  text-left '>
      <div className="container w-full flex ">

        {/* <!-- LEFT SIDE  --> */}
        <div className=" w-[30%] h-[70rem] bg-sky-900  sticky bg-opacity-35  px-8 py-4 rounded-lg  ">
              ...
              <div className="buttons space-y-3">
                ...
                <div className="flex items-center">
                  <input checked id="radio-2" type="radio" value="" name="radio"
                    className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                  <label htmlFor="radio-2" className="ms-2 text-lg font-medium text-gray-900 dark:text-gray-300">InhtmlFormation
                    Technology</label>
                </div>
                <div className="flex items-center">
        ...
        {/* <!-- RIGHT SIDE  --> */}
        <div className="cards-section w-[70%] ">
