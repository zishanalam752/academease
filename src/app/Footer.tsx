...
export default function Footer
    ...
    return (
        <div className='w-full flex flex-col justify-center items-center md:gap-6 gap-4 lg:gap-8 relative bottom-0 left-0 right-0 bg-slate-900 py-10'>
            <div className='w-[70%] h-[280px]  bg-slate-800 rounded-lg flex justify-center items-center absolute bottom-[330px] z-20 ' >
                <div className='flex justify-between items-center h-[40%] gap-20'>
                    <h1 className='text-3xl font-bold border-[1px] p-4 rounded-xl border-slate-700 bg-slate-900'>Would you like to join?<br />Join us today</h1>
                    <Link href="/signup" className=' p-3 px-1 text-lg border-[1px] border-slate-700 rounded-xl bg-slate-900'><button className=' p-3 rounded-lg'>Get started</button></Link>
                </div>
            </div>
            {/* all list */}
